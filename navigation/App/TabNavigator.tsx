  ...
  return (
    <Tab.Navigator screenOptions={({ route }) => ({
      ...
      tabBarIcon: ({ focused, color, size }) => {
        if(route.name==='Home'){
          return(
            <Icon type="antdesign" name="home" size={20} color={focused? pallets.primary: "gray"} />
          )
        }else if (route.name==='Search'){
          return(
            <Icon  type="antdesign" name="search1" size={20} color={focused? pallets.primary: "gray"} />
          )
        }else if (route.name==='My Library'){
          return(
            <Ionicons name="albums" size={20} color={focused? pallets.primary: "gray"} />
          )
        }
      }
    })}>
